...
public class CollectingIntoMapsSolutions {
    ...
    void createSimpleMapFromStream() {
        ...
        Map<String, Integer> collected = stream.collect(Collectors.toMap(s -> s, String::length));
    ...
    void createMapFromStreamWithKeyCollisions() {
        ...
        Map<Integer, String> collected = stream.collect(Collectors.toMap(String::length, s -> s, (a, b) -> a + "," + b));
    ...
    void createMapOfSpecifiedType() {
        ...
        Map<Integer, String> collected = stream.collect(Collectors.toMap(
                String::length,
                s -> s, (a, b) -> a + "," + b,
                TreeMap::new
        ));
